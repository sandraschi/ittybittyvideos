...
async def get_public_settings() -> SettingsPublic:
    ...
    return SettingsPublic(
        ...
        pixabay_api_key_set=bool(settings.pixabay_api_key.strip()),
        pixabay_api_key_hint=_hint_secret(settings.pixabay_api_key),
        coverr_api_key_set=bool(settings.coverr_api_key.strip()),
        coverr_api_key_hint=_hint_secret(settings.coverr_api_key),
        ...
        jellyfin_server_url=settings.jellyfin_server_url or settings.jellyfin_url,
        jellyfin_api_key_set=bool(settings.jellyfin_api_key.strip()),
        jellyfin_api_key_hint=_hint_secret(settings.jellyfin_api_key),
        plex_url=settings.plex_url or settings.plex_server_url,
        plex_token_set=bool(settings.plex_token.strip()),
        plex_token_hint=_hint_secret(settings.plex_token),
